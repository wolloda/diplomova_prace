...
benchmark.evaluate([{'GMM': [{'comp': 8, 'cov_type': 'full', 'max_iter': 5, 'init_params': 'kmeans'}, {'comp': 8, 'cov_type': 'full', 'max_iter': 5, 'init_params': 'kmeans'}, {'comp': 8, 'cov_type': 'full', 'max_iter': 5, 'init_params': 'kmeans'}, {'comp': 8, 'cov_type': 'full', 'max_iter': 5, 'init_params': 'kmeans'}, {'comp': 8, 'cov_type': 'full', 'max_iter': 5, 'init_params': 'kmeans'}]},
