#!/bin/bash
#PBS -N mocap_performance_faiss-logreg_regular_no-AE.sh
#PBS -l select=1:ncpus=2:mem=140gb:ngpus=1 -q gpu_long
...
python3 mocap_performance_faiss-logreg_regular_no-AE.py
