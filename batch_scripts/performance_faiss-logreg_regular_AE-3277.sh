#!/bin/bash
#PBS -N performance_faiss-logreg_regular_AE-3277.sh
#PBS -l select=1:ncpus=2:mem=260gb:ngpus=1 -q gpu_long:ngpus=1 -q gpu
...
python3  performance_faiss-logreg_regular_AE-3277.py
