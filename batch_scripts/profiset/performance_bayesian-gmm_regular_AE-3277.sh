#!/bin/bash
#PBS -N performance_bayesian-gmm_regular_AE-3277.sh
#PBS -l select=1:ncpus=2:mem=230gb:ngpus=1 -q gpu_long
...
python3  performance_bayesian-gmm_regular_AE-3277.py
