...
li = MIndex(PATH="./", mindex="MIndex1M-Profiset-leaf2000/")
#from mindex import MIndex
import pickle
...
li.labels =  ["L1", "L2"]
index_df = load_indexes_profiset("./MIndex1M-Profiset-leaf2000/", li.labels,  filenames=[f'level-{l}.txt' for l in range(1,3)])
index_df = index_df.sort_values(by=["object_id"])
assert index_df.shape[0] == 1000000
objects = get_1M_profiset(index_path="./MIndex1M-Profiset-leaf2000/", objects_path="./datasets/descriptors-decaf-odd-5M-1.data", labels=li.labels)
